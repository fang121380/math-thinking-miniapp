...
const definitions = {
  ...
  3: [
    ...
    { key: 'fraction_compare', kind: 'concept', term: '上册', unit: '分数的初步认识', ability: 'calculation', title: '分数', summary: '同分母分数比较大小时，看分子。', mistakes: ['分母相同才能直接比较分子。'], values: [{ prompt: '1/4表示把整体平均分成几份？', answer: '4', options: ['1', '2', '4', '8'] }, { prompt: '同一块蛋糕的1/2和1/4，哪个大？', answer: '1/2', options: ['1/2', '1/4', '一样大', '无法比较'] }, { prompt: '3/5的分子是？', answer: '3', options: ['3', '5', '8', '15'] }, { prompt: '把一张纸平均分成8份，取3份是____。', answer: '3/8' }, { prompt: '分母相同，分子大的分数____。', answer: '大', hint: '两个分数的分母相同时，只比较分子大小。', steps: ['分母相同，分子越大，表示的份数越多。', '所以分母相同，分子大的分数更大。'] }, { prompt: '1/3+1/3=____。', answer: '2/3', hint: '分母相同，分母保持 3 不变，只把分子相加。', steps: ['1/3+1/3=(1+1)/3。', '1+1=2，所以结果是 2/3。'] }] },
  ...
  5: [
    ...
    { key: 'factor_multiple', kind: 'concept', term: '上册', unit: '因数与倍数', ability: 'calculation', title: '因数和倍数', summary: 'a÷b没有余数时，a是b的倍数，b是a的因数。', mistakes: ['因数和倍数必须成对说。'], values: [{ prompt: '12的因数不包括？', answer: '5', options: ['1', '2', '3', '5'] }, { prompt: '18是6的什么数？', answer: '倍数', options: ['因数', '倍数', '质数', '小数'] }, { prompt: '最小的质数是？', answer: '2', options: ['1', '2', '3', '5'] }, { prompt: '20的最大因数是____。', answer: '20', options: ['1', '10', '20', '40'] }, { prompt: '3的最小倍数是____。', answer: '3', hint: '3×1 就是 3，任何数的最小正倍数是它本身。', steps: ['3 的倍数有 3、6、9……。', '其中最小的正倍数是 3。'] }, { prompt: '2、3、5都是____。', answer: '质数', hint: '质数只有 1 和它本身两个因数。', steps: ['2、3、5 都只能被 1 和本身整除。', '所以 2、3、5 都是质数。'] }] },
    { key: 'fraction_add', kind: 'concept', term: '下册', unit: '分数加减法', ability: 'calculation', title: '同分母分数加减', summary: '同分母分数相加减，分母不变，只算分子。', mistakes: ['分母不能跟着一起加减。'], values: [{ prompt: '2/7+3/7=？', answer: '5/7', options: ['5/14', '5/7', '6/7', '1'] }, { prompt: '6/9-2/9=？', answer: '4/9', options: ['4/18', '4/9', '8/9', '2/9'] }, { prompt: '1/5+1/5=？', answer: '2/5', options: ['2/10', '2/5', '1/5', '1'] }, { prompt: '4/11+3/11=____。', answer: '7/11' }, { prompt: '8/13-5/13=____。', answer: '3/13', hint: '分母相同，分母保持 13 不变，只计算分子 8-5。', steps: ['8/13-5/13=(8-5)/13。', '8-5=3，所以结果是 3/13。'] }, { prompt: '同分母分数加减，分母____。', answer: '不变', hint: '同分母相加减时，下面的分母表示每份大小，不需要改变。', steps: ['分母相同，说明每份大小相同。', '所以相加减时分母不变，只计算分子。'] }] },
  ...
  6: [
    { key: 'fraction_multiply', kind: 'concept', term: '上册', unit: '分数乘法', ability: 'calculation', title: '分数乘法', summary: '分数乘法用分子乘分子、分母乘分母，能约分先约分。', mistakes: ['不要把分子和分母交叉相加。'], values: [{ prompt: '2/3×3/5=？', answer: '2/5', options: ['2/15', '2/5', '5/2', '1'] }, { prompt: '1/4×8=？', answer: '2', options: ['1/2', '2', '4', '8'] }, { prompt: '3/7×7/9=？', answer: '1/3', options: ['1/9', '1/3', '7/9', '10/16'] }, { prompt: '5/6×3/5=____。', answer: '1/2' }, { prompt: '2/9×3/4=____。', answer: '1/6', hint: '先约去 2 和 4 的公因数，再分子乘分子、分母乘分母。', steps: ['2/9×3/4=(2×3)/(9×4)=6/36。', '6/36 约分为 1/6。'] }, { prompt: '分数乘法结果要能约分就____。', answer: '约分', hint: '算出分子和分母后，看看它们有没有公因数。', steps: ['如果分子和分母还有公因数，就把它们同时除以这个数。', '这个过程叫约分。'] }] },
    { key: 'fraction_divide', kind: 'concept', term: '上册', unit: '分数除法', ability: 'calculation', title: '分数除法', summary: '除以一个分数等于乘这个分数的倒数。', mistakes: ['除号变乘号后，只有除数要变倒数。'], values: [{ prompt: '3/4÷1/2=？', answer: '3/2', options: ['3/8', '3/2', '1/2', '2/3'] }, { prompt: '2/5÷4/5=？', answer: '1/2', options: ['8/25', '1/2', '2', '4/2'] }, { prompt: '5/6÷5/3=？', answer: '1/2', options: ['25/18', '1/2', '2', '3/5'] }, { prompt: '4/7÷2/3=____。', answer: '6/7' }, { prompt: '3/8÷9/4=____。', answer: '1/6', hint: '除以分数要改成乘它的倒数，再约分。', steps: ['3/8÷9/4=3/8×4/9=12/72。', '12/72 约分为 1/6。'] }, { prompt: '分数除法要乘除数的____。', answer: '倒数', hint: '除号变成乘号后，被除数不变，只把除数上下交换。', steps: ['除以一个分数，等于乘这个分数的倒数。', '所以应填“倒数”。'] }] },
    ...
    { key: 'negative_number', kind: 'concept', term: '下册', unit: '负数', ability: 'data', title: '负数', summary: '0的左边是负数，离0越远数越小。', mistakes: ['负数比较大小时，绝对值大反而数更小。'], values: [{ prompt: '-3和2，哪个数大？', answer: '2', options: ['-3', '2', '一样大', '无法比较'] }, { prompt: '-5比-2怎样？', answer: '小', options: ['大', '小', '一样', '无法判断'] }, { prompt: '0左边的数叫？', answer: '负数', options: ['正数', '负数', '自然数', '小数'] }, { prompt: '-8+3=____。', answer: '-5' }, { prompt: '温度-2℃比0℃____。', answer: '低', hint: '在数轴或温度计上，-2 在 0 的左边，位置更低。', steps: ['-2 小于 0。', '所以温度 -2℃ 比 0℃低。'] }, { prompt: '-1、0、1中最小的是____。', answer: '-1', hint: '把三个数放在数轴上，越靠左的数越小。', steps: ['数轴上 -1 在 0 的左边，0 在 1 的左边。', '所以最小的是 -1。'] }] },
