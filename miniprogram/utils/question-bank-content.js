...
const thinkingPracticeQuestions = [
  ...
  thinkingItem({ id: 'p-thinking-g4-division-reverse-1', knowledgePoint: 'division_estimation', type: 'choice', difficulty: 3, taskType: 'reverse_reasoning', prompt: '一个数除以 7，商最接近 40。这个数最可能接近哪个数？', options: ['28', '47', '280', '470'], answer: '280', hint: '用除数乘接近的商。', summary: '已知商和除数，可以用乘法反推被除数的大约范围。', steps: ['7×40=280。', '所以这个数最可能接近 280。'], commonMistakes: ['reverse_operation_confusion', 'place_value'] }),
  thinkingItem({ id: 'p-thinking-g4-division-reverse-2', knowledgePoint: 'division_estimation', type: 'fill', difficulty: 3, taskType: 'reverse_reasoning', prompt: '一个数除以 8 的商最接近 60，这个数最接近 ____。', answer: '480', hint: '除数×商≈被除数。', summary: '从商和除数反推被除数，要使用乘法关系。', steps: ['8×60=480。', '所以这个数最接近 480。'], commonMistakes: ['reverse_operation_confusion', 'place_value'] }),
  ...
  thinkingItem({ id: 'p-thinking-g4-multiply-estimate-explain-1', knowledgePoint: 'multiply_estimation', type: 'choice', difficulty: 2, taskType: 'estimate_explain', prompt: '398 × 21 的积最接近哪个整百数？', options: ['6 000', '8 000', '10 000', '12 000'], answer: '8 000', hint: '把 398 和 21 看成容易相乘的数。', summary: '先把因数估成整百或整十，再检查积的数量级。', steps: ['398≈400，21≈20。', '400×20=8 000，所以积最接近 8 000。'], commonMistakes: ['round_wrong_place', 'ignore_magnitude'] }),
  thinkingItem({ id: 'p-thinking-g4-multiply-estimate-explain-2', knowledgePoint: 'multiply_estimation', type: 'fill', difficulty: 2, taskType: 'estimate_explain', prompt: '603 × 48 的积最接近 ____（填整百数）。', answer: '29 000', hint: '603≈600，48≈50。', summary: '用整百乘整十估算，再看最接近哪个整百数。', steps: ['603≈600，48≈50。', '600×50=30 000，精确积 28 944 最接近 29 000。'], commonMistakes: ['round_wrong_place', 'treat_estimate_as_exact'] }),
  ...
  thinkingItem({ id: 'p-thinking-g4-multiply-reverse-1', knowledgePoint: 'multiply_estimation', type: 'choice', difficulty: 3, taskType: 'reverse_reasoning', prompt: '一个因数约是 200，另一个因数约是 30，积大约是？', options: ['600', '6 000', '60 000', '600 000'], answer: '6 000', hint: '200×30 有几个零？', summary: '根据积和一个因数的数量级，可以反推另一个因数。', steps: ['200×30=6 000。', '所以积大约是 6 000。'], commonMistakes: ['reverse_operation_confusion', 'place_value'] }),
  ...
  thinkingItem({ id: 'p-thinking-g4-division-exact-method-1', knowledgePoint: 'division_exact', type: 'choice', difficulty: 3, taskType: 'method_compare', prompt: '计算 936÷24，下面哪种想法最容易检查商？', options: ['把 24×39 算一遍', '只看 936 的个位', '把 24 加 39 次', '直接猜商不验算'], answer: '把 24×39 算一遍', hint: '除数×商应该等于被除数。', summary: '选择能利用逆运算的检查方法。', steps: ['936÷24=39。', '用 24×39=936 检查最直接。'], commonMistakes: ['quotient_place_value', 'skip_check'] }),
  thinkingItem({ id: 'p-thinking-g4-division-exact-method-2', knowledgePoint: 'division_exact', type: 'fill', difficulty: 3, taskType: 'method_compare', prompt: '把 745 个苹果平均装进 24 箱，每箱 31 个，还剩 ____ 个。', answer: '1', hint: '先算 24×31，再用总数减去已经装的。', summary: '有余数的除法要同时关注商和余数。', steps: ['24×31=744。', '745-744=1，所以还剩 1 个。'], commonMistakes: ['ignore_remainder', 'remainder_ge_divisor'] }),
