...
const supplementalPracticeQuestions = [
  ...
  ...problemGroup({
    ...
    rows: [
      ['小敏洗杯子 2 分钟、烧水 6 分钟、泡茶 1 分钟。先洗杯子再烧水，泡茶要等水开，至少几分钟？', '9', '按先后顺序把 2、6、1 分钟相加。', ['洗杯子 2 分钟。', '烧水 6 分钟。', '泡茶 1 分钟。', '共 2+6+1=9 分钟。']],
  ...
  ...problemGroup({
    ...
    rows: [
      ['四天收集树叶数是 18、22、26、30 片，平均每天收集多少片？', '24', '先把四天数量相加，再除以 4 天。', ['18+22+26+30=96。', '96÷4=24（片）。']],
      ['三次口算得分是 84、90、96 分，平均分是多少？', '90', '把三次分数相加，再除以 3 求平均分。', ['84+90+96=270。', '270÷3=90（分）。']],
      ['五个小组分别得到 12、16、18、20、24 颗星，平均每组多少颗？', '18', '先把五组星数相加，再除以 5 组。', ['12+16+18+20+24=90。', '90÷5=18（颗）。']],
